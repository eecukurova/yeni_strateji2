...
if __name__ == "__main__":
    ...
    try:
        ...
        logger.info("Sembol: FETUSDT, Timeframe: 15m, Leverage: 20, Trade Amount: 2000")

        bot = psar_atr_strategy.Bot(symbol='FETUSDT', timeframe='15m', leverage=15, trade_amount=3000)
