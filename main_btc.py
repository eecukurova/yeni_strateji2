...
if __name__ == "__main__":
    ...
    try:
        ...
        logger.info(f"Sembol: BTCUSDT, Timeframe: 15m, Leverage: {leverage}, Trade Amount: {trade_amount}")

        bot = psar_atr_strategy.Bot(symbol='BTCUSDT', timeframe='15m', leverage=leverage, trade_amount=trade_amount)
